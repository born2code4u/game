...
class MarketExample:
    ...
    def __init__(self,x,b1):
        ...
        if x=='AB4_1':
            ...
            verbr=[sfm.Verbrauch('2',3) for x in range(10)]
            verbr.extend([sfm.Verbrauch('1',17) for x in range(8)])
            ...
            AB.players={'1','2'}
            AB.contracts=[]
            self.description={'1': 'You produce 9 (all @5) and you consume 8 units (all @17).',
                              '2': 'You produce 9 (all @15) and you consume 10 units (all @3).'
                              }
            ...
            self.benchmarkcorrection={'1': 30,
                                      '2': 16 }
            # optimal freight to player 1:2x4Dex5+2x2Dex15=12, 2:7x2Dex+3x8Dex15+4x2Dex15=14+24+8=46,total:58, 2x8 + 12x1 + 2x9
            self.optimalFreight=46
